...
$textfactura="COTIZACIÓN NRO ";
$numfactura=$d->idultimacotizacion();
...
<div class="todo">
	...
	<p><strong> JADITH PÉREZ DÍAZ<br>
		<?php echo $n->nit; ?> <br>
	REGIMEN SIMPLIFICADO </strong> </p><br>

	<p><strong> DISTRIBUIDORA AGRICOLA </strong><br>
	Ventas al por mayor y detal de Concentrados de cerdo, Pescados, Pollos y demás para la canasta Agricola.</p>
	<br>
	<p>*********************************</p>
	<h3>COTIZACIÓN</h3>
	<p>*********************************</p>
	...
	<br>
	<p>*********************************</p>
	<p><strong> Cra 7 No. 19-13 <br>
		Celular. <?php echo $n->celular ?> <br>
		CHINU - CORDOBA </strong><br></p>
	</div>
